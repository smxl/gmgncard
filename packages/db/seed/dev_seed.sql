...
INSERT INTO user_profiles (user_id, verification_status, p_size, f_size, age, wechat_qr_url, group_qr_url, notes)
SELECT id, 'approved', '165', '45', 24, 'https://example.com/alice-wechat.png', NULL, 'Core team'
