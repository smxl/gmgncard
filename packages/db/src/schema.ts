...
export const userProfiles = sqliteTable(
  'user_profiles',
  {
    ...
    positionTop: text('position_top'),
    positionBottom: text('position_bottom'),
    positionVers: text('position_vers'),
    positionSide: text('position_side'),
    positionHide: integer('position_hide', { mode: 'boolean' }).notNull().default(false),
    height: integer('height'),
    weight: integer('weight'),
    features: text('features', { mode: 'json' }).$type<Record<string, unknown> | null>(),
